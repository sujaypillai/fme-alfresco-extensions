fme Theme for Alfresco Share
============================

Author: Florian Mail

This project defines an additional theme for Alfresco Share using fme 
company branding and some CSS3 effects. It is based on the Yellow Theme 
that is distributed with alfresco.
...
Console link. In the Application section select 'fme Theme' from the Theme
