<#include "../../../form/controls/common/editorparams.inc.ftl" />
...
<div class="form-field">
    ...
    <#if (form.mode == "edit" && !(field.control.params.disabled?? && field.control.params.disabled == "true")) || (field.control.params.forceEditable?? && field.control.params.forceEditable == "true")>
    	<script type="text/javascript">//<![CDATA[
      (function()
      {
         new Alfresco.RichTextControl("${fieldHtmlId}").setOptions(
         {
            <#if ! (form.mode == "edit" || field.control.params.forceEditable?? && field.control.params.forceEditable == "true") || (field.disabled && !(field.control.params.forceEditable?? && field.control.params.forceEditable == "true"))>disabled: true,</#if>
      ...
      //]]></script>
		...
		//]]></script>
		   ...
		   <label for="${fieldHtmlId}">${field.label?html}:<#if field.mandatory><span class="mandatory-indicator">${msg("form.required.fields.marker")}</span></#if></label>
		      ...
		      <#if (form.mode == "edit" && !(field.control.params.disabled?? && field.control.params.disabled == "true")) || (field.control.params.forceEditable?? && field.control.params.forceEditable == "true")>
		   		<textarea id="${fieldHtmlId}" name="${field.name}" tabindex="0"
