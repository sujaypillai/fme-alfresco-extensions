...
<div id="${el}-configDialog" class="config-dashlet">
   ...
   <div class="bd">
      <form id="${el}-form" action="" method="POST">
            ...
            <div class="yui-u">
            	<div id="${el}-tagSection-div" class="tag-picker">
			    	<div id="${tagPickerId}" class="object-finder">
			            ...
			            <input type="hidden" id="${tagPickerId}-hidden" name="${field.name}" value="${field.value?html}" />
			            <input type="hidden" id="${tagPickerId}-added" name="-" />
			            <input type="hidden" id="${tagPickerId}-removed" name="-" />
         ...
         <div class="yui-gd">
            <div class="yui-u first"><label for="${el}-rowsPerPage">${msg("label.rowsPerPage")}:</label></div>
            <div class="yui-u"><input id="${el}-rowsPerPage" type="text" name="rowsPerPage" value=""/>&nbsp;*</div>
         </div>
         <div class="bdft">
